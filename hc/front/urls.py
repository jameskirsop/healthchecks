...
project_urls = [
    ...
    path("add_connectwisemanage/", views.add_connectwisemanage, name="hc-add-connectwisemanage"),
    path("add_connectwisemanage/boards", views.add_connectwisemanage_board, name="hc-add-connectwisemanage-board"),
    path("add_connectwisemanage/boardsstatus", views.add_connectwisemanage_boardstatus, name="hc-add-connectwisemanage-boardstatus"),
